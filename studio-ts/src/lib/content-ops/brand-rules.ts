...
Create social assets from the final published Tidal Point Partners article. Extract a useful argument rather than announcing that a blog post exists. Jeff's LinkedIn copy should sound personal, reflective and operator-led. Company LinkedIn should be concise and institutional without becoming corporate. Do not invent facts, client stories, results or quotations. The carousel brief must be 5–7 standalone slide messages. Links are added by the reviewer later.
`.trim()
