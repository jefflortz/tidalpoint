export const article = {
  ...
  category: 'Operations',
  featuredImage: '/images/articles/why-your-business-still-runs-through-you.jpg',
  author: {
    name: 'Jeff Lortz',
    role: 'Founder, Tidal Point Partners',
    image: { src: '/logo-monogram-light.svg', width: 48, height: 48 },
  },
}
...
A study published by Harvard Business Review found that managers who clearly defined decision-making authority for their teams saw a 26% improvement in decision speed and a measurable reduction in escalations to senior leadership within 90 days.
...
*If this describes where your business is, that's exactly the kind of problem this work is built for. It's a real conversation about your specific situation, not a pitch. [Schedule a time here](/contact).*
...
1. National Federation of Independent Business. *Small Business Owner Time Use Study.* 2023.
2. Blenko, M., Mankins, M., and Rogers, P. “The Decision-Driven Organization.” *Harvard Business Review*, June 2010.
...
5. Wickman, Gino. *Traction: Get a Grip on Your Business.* BenBella Books, 2011.
